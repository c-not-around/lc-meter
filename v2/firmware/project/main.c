...
#define C_CAL				1.78e-9d // measured using XJW-01
#define CE_CHARGE_R1		1997.5d  // measured using XJW-01
#define CE_CHARGE_R2		200.4d   // measured using XJW-01
...
MAIN()
{
	INITIALIZATION()
	{
		 ...
		 * PB0 - I - unused
		 */
		PORTS.B.OUT = 0b11100001;
		PORTS.B.DIR = 0b00011111;
		 ...
		 * PC0 - I - unused
		 */
		PORTS.C.OUT = 0b00111001;
		PORTS.C.DIR = 0b00000110;
